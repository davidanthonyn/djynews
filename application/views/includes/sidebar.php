    ...
    <div class="card-body">
      <form name="search" action="search.php" method="post">
        <div class="input-group">
          <?php
          echo "<img src='https://openweathermap.org/img/w/" . $temperature_current_weather_icon . ".png' /><br>";

          echo " $temperature_in_celcius  °C, $campus_name";
  ...
  <div class="card-body">
    <form name="search" action="search.php" method="post">
      <div class="input-group">
        ...
        <input type="text" name="kota" class="form-control" placeholder="Search for..." required>
        <span class="input-group-btn">
          <button class="btn btn-secondary" type="submit">Go!</button>
        </span>
    </form>
